...
An AI-powered cognitive agent designed to eliminate HS code misclassifications and calculate exact landing costs for shipments entering Nigerian ports (Apapa, Tin Can, etc.) using the official ECOWAS Common External Tariff (CET).
...
1. **Clone the Repository:**
   ```bash
   git clone [https://github.com/YOUR_USERNAME/YOUR_REPOSITORY.git](https://github.com/dappatamuno/ncs-duty-calculator-rag.git)
   cd dappatamuno